...
export class MainPage {
  ...
  acceptPolicyButtonSelector = 'button.wt-btn.wt-btn--primary.wt-width-full.wt-mt-xs-3.wt-mb-xs-3.wt-mr-xs-3';




  visit() {
    console.log("Visiting", this.host);
    cy.visit(this.host);
  }

  acceptDefaultPrivacyPolicySettings() {
  ...
  constructor() {
    ...
    this.acceptPolicyButton = cy.get(this.acceptPolicyButtonSelector);
  }
  ...
  searchFor(searchQuery) {
    console.log("Start searching for", searchQuery);
    this.searchFieldComponent.searchFor(searchQuery);
  }
}
